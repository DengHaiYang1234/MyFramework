...
{
    public class BuildLuaAssetBundles
    {
        ...
        private static BuildTarget currTarget = BuildTarget.NoTarget;
        //项目路径
        ...
        //流文件路径
        static string LuaDataPath
        {
            get { return BuildDefaultPath.BuildLuaAssetBundlePath; }
        }
        ...
        public static bool BuildAssetResource(BuildTarget target,bool delfold = true)
        {
            bundles.Clear();
        ...
        static void HandleLuaBundle()
        {
            ...
            string luaPath = LuaDataPath + "/lua/";
            string[] luaPaths =
            {
        ...
        #region 10.开始打包Lua资源
        static void BuildAssetsResource()
        {
            ...
            BuildPipeline.BuildAssetBundles(outPut, bundles.ToArray(), options, currTarget);
            AssetDatabase.Refresh();
        }
        ...
        {
            string versionPath = LuaDataPath + "/version.txt";
        ...
        {
            string newFilePath = LuaDataPath + "/files.txt";
